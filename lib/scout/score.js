...
- HARD DISQUALIFIERS (score 20 or below regardless of title, even if tagged "remote"): the role requires US citizenship, a security clearance (TS/SCI, Public Trust), or is a US federal / government / "Public Sector - Fed" / defense contract, AND the candidate is not a US citizen with clearance. These are closed to them in practice.
