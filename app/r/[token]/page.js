...
const CSS = `
.ms{--ms-bg:#0b0b0f;--ms-fg:#f4f4f5;--ms-mut:#a1a1aa;--ms-line:#26262c;--ms-card:#141419;--ms-acc:#8b8bff;min-height:100vh;background:var(--ms-bg);color:var(--ms-fg);font-family:Inter,system-ui,sans-serif;-webkit-font-smoothing:antialiased;}
...
.ms-summary{font-size:16px;line-height:1.7;color:#d4d4d8;max-width:640px;margin:0 0 22px;}
...
.ms-card-body{font-size:14px;line-height:1.6;color:#c7c7cf;margin:0 0 14px;}
.ms-chips{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:14px;}
.ms-chip{font-size:11.5px;font-weight:600;color:var(--ms-mut);background:#1c1c22;border:1px solid var(--ms-line);border-radius:999px;padding:4px 10px;}
...
.ms-role-body{font-size:14px;line-height:1.6;color:#c7c7cf;margin:8px 0 0;}
...
@media (prefers-color-scheme:light){.ms{--ms-bg:#fbfbfa;--ms-fg:#18181b;--ms-mut:#71717a;--ms-line:#e7e5e4;--ms-card:#ffffff;--ms-acc:#4f46e5;}}
`;
